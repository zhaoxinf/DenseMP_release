...
def main(_run, _config, _log):
    ...
    print(f'mar_val batches classDice: {m_classDice}')
    print(f'mar_val batches meanDice: {m_meanDice}')

    print(f'mar_val batches classPrec: {m_classPrec}')
    print(f'mar_val batches meanPrec: {m_meanPrec}')

    print(f'mar_val batches classRec: {m_classRec}')
    print(f'mar_val batches meanRec: {m_meanRec}')
