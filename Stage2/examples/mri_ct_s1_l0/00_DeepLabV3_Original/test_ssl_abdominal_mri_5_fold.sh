...
do
    ...
    do
        ...
        RELOAD_PATH="exps/mri_ct_s1_l0/00_DeepLabV3_Original_Train_MIDDLE_0/mySSL_train_5_fold_CHAOST2_Superpix_lbgroup0_scale_MIDDLE_vfold${EVAL_FOLD}_CHAOST2_Superpix_sets_0_1shot/1/snapshots/${MODEL_EPOCH}.pth"  # path to the reloaded model
