...
do
    ...
    do
        ...
        RELOAD_PATH="exps/mri_ct_s1_l0/02_DenseCL_Medical_Train_MIDDLE_0/mySSL_train_densecl_5_fold_SABS_Superpix_lbgroup0_scale_MIDDLE_vfold${EVAL_FOLD}_SABS_Superpix_sets_0_1shot/1/snapshots/${MODEL_EPOCH}.pth" # path to the reloaded model
