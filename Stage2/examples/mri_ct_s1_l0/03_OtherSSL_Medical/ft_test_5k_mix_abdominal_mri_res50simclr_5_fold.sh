...
do
    ...
    do
        ...
        RELOAD_PATH="exps/mri_ct_s1_l0/03_Res50SimCLR_Medical_Ft_Train_5k_MIX_0/mySSL_ft_train_5_fold_CHAOST2_lbgroup0_MIX_vfold${EVAL_FOLD}_CHAOST2_sets_0_1shot/1/snapshots/${MODEL_EPOCH}.pth"  # path to the reloaded model
