...
CPT="00_DeepLabV3_Original_Test"
...
do
    ...
    do
        ...
        PREFIX="test_5_fold_${DATASET}_lbgroup${LABEL_SETS}_scale_${SUPERPIX_SCALE}_vfold${EVAL_FOLD}_epoch${MODEL_EPOCH}"
        echo $PREFIX
        ...
        RELOAD_PATH="exps/mri_ct_s1_l1/00_DeepLabV3_Original_Train_MIDDLE_1/mySSL_train_5_fold_CHAOST2_Superpix_lbgroup1_scale_MIDDLE_vfold${EVAL_FOLD}_CHAOST2_Superpix_sets_1_1shot/1/snapshots/${MODEL_EPOCH}.pth"  # path to the reloaded model
