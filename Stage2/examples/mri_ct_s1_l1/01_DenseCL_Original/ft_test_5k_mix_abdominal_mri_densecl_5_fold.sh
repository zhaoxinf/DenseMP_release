...
do
    ...
    do
        ...
        RELOAD_PATH="exps/mri_ct_s1_l1/01_DenseCL_Original_Ft_Train_5k_MIX_1/mySSL_ft_train_5_fold_CHAOST2_lbgroup1_MIX_vfold${EVAL_FOLD}_CHAOST2_sets_1_1shot/1/snapshots/${MODEL_EPOCH}.pth"  # path to the reloaded model
