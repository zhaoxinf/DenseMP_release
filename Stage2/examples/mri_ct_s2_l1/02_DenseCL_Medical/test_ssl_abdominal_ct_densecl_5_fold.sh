...
do
    ...
    do
        ...
        RELOAD_PATH="exps/mri_ct_s2_l1/02_DenseCL_Medical_Train_MIDDLE_1/mySSL_train_densecl_5_fold_SABS_Superpix_lbgroup1_scale_MIDDLE_vfold${EVAL_FOLD}_SABS_Superpix_sets_1_1shot/1/snapshots/${MODEL_EPOCH}.pth" # path to the reloaded model
