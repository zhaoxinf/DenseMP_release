...
do
    ...
    do
        ...
        RELOAD_PATH="exps/mri_ct_s2_l1/03_SwinSimMIM_Medical_Ft_Train_5k_MIX_1/mySSL_ft_train_5_fold_SABS_lbgroup1_MIX_vfold${EVAL_FOLD}_SABS_sets_1_1shot/1/snapshots/${MODEL_EPOCH}.pth" # path to the reloaded model
